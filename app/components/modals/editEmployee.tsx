      ...
      <div className="w-[500px] rounded-2xl border border-zinc-800 bg-zinc-900 p-6">
        ...
        <div className="mt-6 flex justify-end gap-2">
          ...
          <button
            ...
            className="inline-flex cursor-pointer items-center gap-1.5 rounded-xl bg-red-600 px-4 py-2 text-sm font-medium transition-colors hover:bg-red-500"
          >
          ...
          {deleteModalOpen && (
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70">
              <div className="bg-black p-8 rounded-xl border-2 border-zinc-700">
